...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.isGrounded && !brokenLeg)
            {
                if (aktualnaWysokoscSkoku < -20)
                {
                    BrokenLeg();
                }
        ...
        private void UpdateCameraPosition(float speed)
        {
            ...
            if(m_CharacterController.velocity.magnitude > 0 && m_CharacterController.isGrounded && brokenLeg)
            {
                //if broken leg
                m_Camera.transform.localPosition = m_HeadBob.DoHeadBob(5.0f);
